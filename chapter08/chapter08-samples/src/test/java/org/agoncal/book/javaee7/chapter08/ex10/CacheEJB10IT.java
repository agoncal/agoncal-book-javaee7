package org.agoncal.book.javaee7.chapter08.ex10;
...
public class CacheEJB10IT {
  ...
  public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
    ...
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB10!org.agoncal.book.javaee7.chapter08.ex10.CacheEJB10"));
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB10"));

    // Looks up the EJB
    CacheEJB10 cacheEJB = (CacheEJB10) ctx.lookup("java:global/classes/CacheEJB10!org.agoncal.book.javaee7.chapter08.ex10.CacheEJB10");
