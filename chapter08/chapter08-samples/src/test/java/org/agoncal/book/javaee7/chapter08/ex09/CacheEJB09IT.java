...
public class CacheEJB09IT {
  ...
  public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
    ...
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB09!org.agoncal.book.javaee7.chapter08.ex09.CacheEJB09"));
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB09"));

    // Looks up the EJB
    CacheEJB09 cacheEJB = (CacheEJB09) ctx.lookup("java:global/classes/CacheEJB09!org.agoncal.book.javaee7.chapter08.ex09.CacheEJB09");
