 ...
 *         --
 *         <p/>
 *         GET the books in XML : curl http://localhost:8080/chapter20-service-1.0/rs/03/books
 *         GET the books in JSon : curl -H "Accept: application/json" http://localhost:8080/chapter20-service-1.0/rs/03/books
 *         <p/>
 *         POST a new book : curl -X POST --data-binary "{ \"title\":\"H2G2\", \"description\":\"Scifi IT book\", \"illustrations\":\"false\",\"isbn\":\"
 *         134-234\",\"nbOfPage\":\"241\",\"price\":\"24.0\" }" -H "Content-Type: application/json" http://localhost:8080/chapter20-service-1.0/rs/03/books -v
 */
@Path("/03/books")
@Stateless
