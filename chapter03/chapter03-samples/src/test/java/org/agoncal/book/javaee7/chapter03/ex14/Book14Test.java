...
public class Book14Test {
  ...
  public void shouldRaiseNoConstraintViolation() {
    ...
    Set<ConstraintViolation<Book14>> constraints = validator.validate(book);
  ...
  public void shouldRaiseConstraintsViolationCauseValidatingOnlyTitle() {
    ...
    Set<ConstraintViolation<Book14>> constraints = validator.validateProperty(book, "title");
    displayContraintViolations(constraints);
    assertEquals(1, constraints.size());
  }
  ...
  public void shouldRaiseConstraintsViolationCheckingTheTitleValue() {
    ...
    Set<ConstraintViolation<Book14>> constraints = validator.validateValue(Book14.class, "title", null);
    displayContraintViolations(constraints);
    assertEquals(1, constraints.size());
  }
