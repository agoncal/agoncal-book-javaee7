...
public class CacheEJB11IT {
  ...
  public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
    ...
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB11!org.agoncal.book.javaee7.chapter07.ex11.CacheEJB11"));
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB11"));

    // Looks up the EJB
    CacheEJB11 cacheEJB = (CacheEJB11) ctx.lookup("java:global/classes/CacheEJB11!org.agoncal.book.javaee7.chapter07.ex11.CacheEJB11");
