...
public class CacheEJB12IT {
  ...
  public void shouldAddRemoveAndGetThingsFromTheCache() throws Exception {
    ...
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB12!org.agoncal.book.javaee7.chapter07.ex12.CacheEJB12"));
    assertNotNull(ctx.lookup("java:global/classes/CacheEJB12"));

    // Looks up the EJB
    CacheEJB12 cacheEJB = (CacheEJB12) ctx.lookup("java:global/classes/CacheEJB12!org.agoncal.book.javaee7.chapter07.ex12.CacheEJB12");
