 ...
 *         --
 *         <p/>
 *         GET the books in XML : curl http://localhost:8080/chapter22-service-1.0/rs/04/books
 *         GET the books in JSon : curl -H "Accept: application/json" http://localhost:8080/chapter22-service-1.0/rs/04/books
 *         <p/>
 *         POST a book with title : curl -X POST --data-binary "H2G2" -H "Content-Type: text/plain" http://localhost:8080/chapter22-service-1.0/rs/04/books -v
 *         <p/>
 *         POST a new book : curl -X POST --data-binary "{ \"title\":\"H2G2\", \"description\":\"Scifi IT book\", \"illustrations\":\"false\",\"isbn\":\"134-234\",\"nbOfPage\":\"241\",\"price\":\"24.0\" }" -H "Content-Type: application/json" http://localhost:8080/chapter22-service-1.0/rs/04/books -v
 *         POST a new book : curl -X POST --data-binary "<book04><description>Science fiction comedy book</description><illustrations>false</illustrations><isbn>1-84023-742-2</isbn><nbOfPage>354</nbOfPage><price>12.5</price><title>The Hitchhiker's Guide to the Galaxy</title></book04>" -H "Content-Type: application/xml" http://localhost:8080/chapter22-service-1.0/rs/04/books -v
 *         <p/>
 *         DELETE a book : curl -X DELETE -H "Content-Type: text/plain" http://localhost:8080/chapter22-service-1.0/rs/04/books/2 -v
 */
@Path("/04/books")
@Stateless
