...
public class ItemRestService05 {
  ...
  /**
   * curl http://localhost:8080/chapter22-service-1.0/rs/05/items/books
   */
  @GET
  @Path("/books")
  ...
  /**
   * curl http://localhost:8080/chapter22-service-1.0/rs/05/items/books/1234
   */
  @GET
  @Path("/book/{bookid}")
  ...
  /**
   * curl -X POST http://localhost:8080/chapter22-service-1.0/rs/05/items/books
   */
  @POST
  @Path("/book")
