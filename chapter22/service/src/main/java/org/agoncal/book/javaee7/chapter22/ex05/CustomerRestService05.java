...
public class CustomerRestService05 {
    ...
    /**
     * curl http://localhost:8080/chapter22-service-1.0/rs/05/customers
     */
    @GET
    ...
    /**
     * curl -H "Accept: text/html" http://localhost:8080/chapter22-service-1.0/rs/05/customers
     */
    @GET
    ...
    /**
     * curl -H "Accept: application/json" http://localhost:8080/chapter22-service-1.0/rs/05/customers
     */
    @GET
