...
public class ItemRestService04 {
    ...
    /**
     * curl http://localhost:8080/chapter22-service-1.0/rs/04/items
     */
    @GET
    ...
    /**
     * curl http://localhost:8080/chapter22-service-1.0/rs/04/items/1234
     */
    @GET
    @Path("{itemid}")
    ...
    /**
     * curl -X DELETE http://localhost:8080/chapter22-service-1.0/rs/04/items/1234
     */
    @DELETE
    @Path("{itemid}")
    ...
    /**
     * curl http://localhost:8080/chapter22-service-1.0/rs/04/items/books
     */
    @GET
    @Path("/books/")
    ...
    /**
     * curl http://localhost:8080/chapter22-service-1.0/rs/04/items/books/1234
     */
    @GET
    @Path("/books/{bookid}")
